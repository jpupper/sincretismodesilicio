...
function getColdSynonym(word) {
  ...
  // Respaldo analógico con palabras sintéticas puras
  const SINGLE_TECH_WORDS = [
    'PROTOCOLO', 'VECTOR', 'MÓDULO', 'UNIDAD', 'MATRIZ',
    'NÚCLEO', 'SÍNTESIS', 'PARÁMETRO', 'VARIABLE', 'TELEMETRÍA',
    'PROYECCIÓN', 'COMPILACIÓN', 'TERMINAL', 'REGISTRO', 'CONVERGENCIA',
    'MEMBRANA', 'GRADIENTE', 'ESTRUCTURA', 'CIRCUITO', 'ENCRIPTACIÓN',
    'SISTEMA', 'VÍNCULO', 'DOMINIO', 'LÁMINA', 'ENIGMA', 'DISPOSITIVO'
  ];
